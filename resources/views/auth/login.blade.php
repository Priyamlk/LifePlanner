...
<div id="single-wrapper">
	<form class="frm-single" method="POST" action="{{ route('login') }}">
		...
		<div class="inside">
			...
			<!-- /.frm-title -->
			<div class="frm-input"><input type="text" placeholder="Email" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
			<!-- /.frm-input -->
			...
			<!-- /.row -->
			<a href="/register" class="a-link"><i class="fa fa-key"></i>New to Life Planner? Register.</a>

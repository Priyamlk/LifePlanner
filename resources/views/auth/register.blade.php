...
<div id="single-wrapper">
    <form class="frm-single" method="POST" action="{{ route('register') }}">
        @csrf
		<div class="inside">
			<div class="title"><strong>Life Planner</strong>IUser</div>
			<!-- /.title -->
			<div class="frm-title">Register</div>
			<!-- /.frm-title -->
			<div class="frm-input">
                <input type="text" placeholder="First Name" class="frm-inp"><i class="fa fa-envelope frm-ico"></i>
                <div class="col-md-6">
            ...
            <!---->
            <div class="frm-input">
                <input type="text" placeholder="Last Name" class="frm-inp"><i class="fa fa-envelope frm-ico"></i>
                <div class="col-md-6">
			...
			<!-- /.frm-input -->
			<div class="frm-input">
                <input type="text" placeholder="Email" class="frm-inp"><i class="fa fa-envelope frm-ico"></i>
                <div class="col-md-6">
			...
			<!-- /.frm-input -->
			<div class="frm-input">
                <input type="text" placeholder="Mobile" class="frm-inp"><i class="fa fa-envelope frm-ico"></i>
                <div class="col-md-6">
            ...
            <div class="frm-input">
                <input type="text" placeholder="Password" class="frm-inp"><i class="fa fa-envelope frm-ico"></i>
                <div class="col-md-6">

...
Route::prefix('admin')->name('admin.')->group(function() {
 ...
 Route::prefix('offer')->name('offer.')->group(function() {
    ...
    Route::post('/store', 'Admin\OfferController@store')->name('store');
...
Route::get('/useractivity', 'Admin\ActivityController@index')->name('index');
Route::get('/useractivity/{id}/view', 'Admin\ActivityController@show')->name('view');
});
        ...
        Route::prefix('product')->name('product.')->group(function() {
            ...
            Route::get('subcatories/{id}', 'Admin\ProductController@loadSubCategories');
        });
